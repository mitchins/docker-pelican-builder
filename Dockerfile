...
RUN mkdir -p lib && \
cd lib; curl  -L https://github.com/getpelican/pelican-plugins/archive/master.tar.gz | tar xz && \
cd lib; curl  -L https://github.com/pR0Ps/pelican-yaml-metadata/archive/master.tar.gz | tar xz
